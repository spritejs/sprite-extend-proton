...
var _texturedParticle = require('./textured-particle');

var _texturedParticle2 = _interopRequireDefault(_texturedParticle);
...
var _class = function (_CustomRenderer) {
  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function createParticle(particle) {
      var s = void 0;
      if (particle.body) {
        s = new _texturedParticle2.default();
        s.textures = particle.body;
      } else {
        s = new _particle2.default();
